...
var Events = function() {
	function Events$1(eventType, eventFunctions) {
		if (eventFunctions === void 0) eventFunctions = [];
		this._eventType = eventType;
		this._eventFunctions = eventFunctions;
	}
	Events$1.prototype.init = function() {
		var _this = this;
...
var Accordion = function() {
	function Accordion$1(accordionEl, items, options, instanceOptions) {
	...
	Accordion$1.prototype.destroy = function() {
		if (this._items.length && this._initialized) {
			this._items.forEach(function(item) {
	...
	Accordion$1.prototype.removeInstance = function() {
		instances_default.removeInstance("Accordion", this._instanceId);
	};
	Accordion$1.prototype.destroyAndRemoveInstance = function() {
		this.destroy();
		this.removeInstance();
	};
	Accordion$1.prototype.getItem = function(id) {
		return this._items.filter(function(item) {
			return item.id === id;
		})[0];
	};
	Accordion$1.prototype.open = function(id) {
		var _a, _b;
		var _this = this;
		...
		if (!this._options.alwaysOpen) this._items.map(function(i) {
			var _a$1, _b$1;
			if (i !== item) {
				(_a$1 = i.triggerEl.classList).remove.apply(_a$1, _this._options.activeClasses.split(" "));
				(_b$1 = i.triggerEl.classList).add.apply(_b$1, _this._options.inactiveClasses.split(" "));
	...
	Accordion$1.prototype.toggle = function(id) {
		var item = this.getItem(id);
		if (item.active) this.close(id);
		else this.open(id);
		this._options.onToggle(this, item);
	};
	Accordion$1.prototype.close = function(id) {
		var _a, _b;
		var item = this.getItem(id);
	...
	Accordion$1.prototype.updateOnOpen = function(callback) {
		this._options.onOpen = callback;
	};
	Accordion$1.prototype.updateOnClose = function(callback) {
		this._options.onClose = callback;
	};
	Accordion$1.prototype.updateOnToggle = function(callback) {
...
var Collapse = function() {
	function Collapse$1(targetEl, triggerEl, options, instanceOptions) {
	...
	Collapse$1.prototype.init = function() {
		var _this = this;
	...
	Collapse$1.prototype.destroy = function() {
		if (this._triggerEl && this._initialized) {
			this._triggerEl.removeEventListener("click", this._clickHandler);
			this._initialized = false;
		}
	};
	Collapse$1.prototype.removeInstance = function() {
		instances_default.removeInstance("Collapse", this._instanceId);
	};
	Collapse$1.prototype.destroyAndRemoveInstance = function() {
		this.destroy();
		this.removeInstance();
	};
	Collapse$1.prototype.collapse = function() {
		this._targetEl.classList.add("hidden");
		if (this._triggerEl) this._triggerEl.setAttribute("aria-expanded", "false");
		this._visible = false;
		this._options.onCollapse(this);
	};
	Collapse$1.prototype.expand = function() {
		this._targetEl.classList.remove("hidden");
		if (this._triggerEl) this._triggerEl.setAttribute("aria-expanded", "true");
		this._visible = true;
		this._options.onExpand(this);
	};
	Collapse$1.prototype.toggle = function() {
		if (this._visible) this.collapse();
		else this.expand();
		this._options.onToggle(this);
	};
	Collapse$1.prototype.updateOnCollapse = function(callback) {
		this._options.onCollapse = callback;
	};
	Collapse$1.prototype.updateOnExpand = function(callback) {
		this._options.onExpand = callback;
	};
	Collapse$1.prototype.updateOnToggle = function(callback) {
		this._options.onToggle = callback;
	};
	return Collapse$1;
}();
function initCollapses() {
	document.querySelectorAll("[data-collapse-toggle]").forEach(function($triggerEl) {
		...
		if ($targetEl) if (!instances_default.instanceExists("Collapse", $targetEl.getAttribute("id"))) new Collapse($targetEl, $triggerEl);
		else new Collapse($targetEl, $triggerEl, {}, { id: $targetEl.getAttribute("id") + "_" + instances_default._generateRandomId() });
...
var Carousel = function() {
	function Carousel$1(carouselEl, items, options, instanceOptions) {
	...
	*/
	Carousel$1.prototype.init = function() {
		var _this = this;
		if (this._items.length && !this._initialized) {
	...
	Carousel$1.prototype.destroy = function() {
		if (this._initialized) this._initialized = false;
	};
	Carousel$1.prototype.removeInstance = function() {
		instances_default.removeInstance("Carousel", this._instanceId);
	};
	Carousel$1.prototype.destroyAndRemoveInstance = function() {
		this.destroy();
		this.removeInstance();
	};
	Carousel$1.prototype.getItem = function(position) {
	...
	* @param {*} position
	*/
	Carousel$1.prototype.slideTo = function(position) {
	...
	*/
	Carousel$1.prototype.next = function() {
	...
	*/
	Carousel$1.prototype.prev = function() {
		var activeItem = this.getActiveItem();
		var prevItem = null;
	...
	* @param {*} rotationItems
	*/
	Carousel$1.prototype._rotate = function(rotationItems) {
		this._items.map(function(item) {
	...
	*/
	Carousel$1.prototype.cycle = function() {
		var _this = this;
	...
	*/
	Carousel$1.prototype.pause = function() {
		clearInterval(this._intervalInstance);
	};
	/**
	* Get the currently active item
	*/
	Carousel$1.prototype.getActiveItem = function() {
	...
	* @param {*} position
	*/
	Carousel$1.prototype._setActiveItem = function(item) {
		var _a, _b;
		var _this = this;
		...
		if (this._indicators.length) {
			this._indicators.map(function(indicator) {
				...
				(_a$1 = indicator.el.classList).remove.apply(_a$1, _this._options.indicators.activeClasses.split(" "));
				(_b$1 = indicator.el.classList).add.apply(_b$1, _this._options.indicators.inactiveClasses.split(" "));
			});
	...
	Carousel$1.prototype.updateOnNext = function(callback) {
		this._options.onNext = callback;
	};
	Carousel$1.prototype.updateOnPrev = function(callback) {
		this._options.onPrev = callback;
	};
	Carousel$1.prototype.updateOnChange = function(callback) {
...
var Dismiss = function() {
	function Dismiss$1(targetEl, triggerEl, options, instanceOptions) {
		if (targetEl === void 0) targetEl = null;
		if (triggerEl === void 0) triggerEl = null;
	...
	Dismiss$1.prototype.init = function() {
		var _this = this;
		if (this._triggerEl && this._targetEl && !this._initialized) {
			this._clickHandler = function() {
				_this.hide();
	...
	Dismiss$1.prototype.destroy = function() {
		if (this._triggerEl && this._initialized) {
			this._triggerEl.removeEventListener("click", this._clickHandler);
			this._initialized = false;
		}
	};
	Dismiss$1.prototype.removeInstance = function() {
		instances_default.removeInstance("Dismiss", this._instanceId);
	};
	Dismiss$1.prototype.destroyAndRemoveInstance = function() {
		this.destroy();
		this.removeInstance();
	};
	Dismiss$1.prototype.hide = function() {
		var _this = this;
	...
	Dismiss$1.prototype.updateOnHide = function(callback) {
	...
	return function createPopper$1(reference$1, popper$1, options) {
		...
		var instance = {
			...
			setOptions: function setOptions(setOptionsAction) {
				...
				state.options = Object.assign({}, defaultOptions$1, state.options, options$1);
				state.scrollParents = {
...
var Dropdown = function() {
	function Dropdown$1(targetElement, triggerElement, options, instanceOptions) {
	...
	Dropdown$1.prototype.init = function() {
		if (this._triggerEl && this._targetEl && !this._initialized) {
	...
	Dropdown$1.prototype.destroy = function() {
		var _this = this;
	...
	Dropdown$1.prototype.removeInstance = function() {
		instances_default.removeInstance("Dropdown", this._instanceId);
	};
	Dropdown$1.prototype.destroyAndRemoveInstance = function() {
		this.destroy();
		this.removeInstance();
	};
	Dropdown$1.prototype._setupEventListeners = function() {
		var _this = this;
		var triggerEvents = this._getTriggerEvents();
		this._clickHandler = function() {
			_this.toggle();
	...
	Dropdown$1.prototype._createPopperInstance = function() {
	...
	Dropdown$1.prototype._removeClickOutsideListener = function() {
		document.body.removeEventListener("click", this._clickOutsideEventListener, true);
	};
	Dropdown$1.prototype._handleClickOutside = function(ev, targetEl) {
	...
	Dropdown$1.prototype._getTriggerEvents = function() {
	...
	Dropdown$1.prototype.toggle = function() {
		if (this.isVisible()) this.hide();
		else this.show();
		this._options.onToggle(this);
	};
	Dropdown$1.prototype.isVisible = function() {
	...
	Dropdown$1.prototype.updateOnShow = function(callback) {
		this._options.onShow = callback;
	};
	Dropdown$1.prototype.updateOnHide = function(callback) {
		this._options.onHide = callback;
	};
	Dropdown$1.prototype.updateOnToggle = function(callback) {
		this._options.onToggle = callback;
	};
	return Dropdown$1;
}();
...
var Modal = function() {
	function Modal$1(targetEl, options, instanceOptions) {
		if (targetEl === void 0) targetEl = null;
	...
	Modal$1.prototype.init = function() {
		var _this = this;
	...
	Modal$1.prototype.destroy = function() {
	...
	Modal$1.prototype.removeInstance = function() {
		instances_default.removeInstance("Modal", this._instanceId);
	};
	Modal$1.prototype.destroyAndRemoveInstance = function() {
		this.destroy();
		this.removeInstance();
	};
	Modal$1.prototype._createBackdrop = function() {
		var _a;
		if (this._isHidden) {
	...
	Modal$1.prototype._destroyBackdropEl = function() {
		if (!this._isHidden && this._backdropEl) {
			this._backdropEl.remove();
			this._backdropEl = null;
		}
	};
	Modal$1.prototype._setupModalCloseEventListeners = function() {
		var _this = this;
	...
	Modal$1.prototype._removeModalCloseEventListeners = function() {
	...
	Modal$1.prototype._handleOutsideClick = function(target) {
		if (target === this._targetEl || target === this._backdropEl && this.isVisible()) this.hide();
	};
	Modal$1.prototype._getPlacementClasses = function() {
	...
	Modal$1.prototype.toggle = function() {
		if (this._isHidden) this.show();
		else this.hide();
		this._options.onToggle(this);
	};
	Modal$1.prototype.show = function() {
		if (this.isHidden) {
	...
	Modal$1.prototype.hide = function() {
		if (this.isVisible) {
			this._targetEl.classList.add("hidden");
	...
	Modal$1.prototype.isVisible = function() {
		return !this._isHidden;
	};
	Modal$1.prototype.isHidden = function() {
		return this._isHidden;
	};
	Modal$1.prototype.addEventListenerInstance = function(element, type, handler) {
	...
	Modal$1.prototype.removeAllEventListenerInstances = function() {
		this._eventListenerInstances.map(function(eventListenerInstance) {
			eventListenerInstance.element.removeEventListener(eventListenerInstance.type, eventListenerInstance.handler);
		});
		this._eventListenerInstances = [];
	};
	Modal$1.prototype.getAllEventListenerInstances = function() {
		return this._eventListenerInstances;
	};
	Modal$1.prototype.updateOnShow = function(callback) {
		this._options.onShow = callback;
	};
	Modal$1.prototype.updateOnHide = function(callback) {
		this._options.onHide = callback;
	};
	Modal$1.prototype.updateOnToggle = function(callback) {
		this._options.onToggle = callback;
	};
	return Modal$1;
}();
...
var Drawer = function() {
	function Drawer$1(targetEl, options, instanceOptions) {
		if (targetEl === void 0) targetEl = null;
	...
	Drawer$1.prototype.init = function() {
		var _this = this;
		if (this._targetEl && !this._initialized) {
			this._targetEl.setAttribute("aria-hidden", "true");
	...
	Drawer$1.prototype.destroy = function() {
		if (this._initialized) {
			this.removeAllEventListenerInstances();
			this._destroyBackdropEl();
	...
	Drawer$1.prototype.removeInstance = function() {
		instances_default.removeInstance("Drawer", this._instanceId);
	};
	Drawer$1.prototype.destroyAndRemoveInstance = function() {
		this.destroy();
		this.removeInstance();
	};
	Drawer$1.prototype.hide = function() {
		var _this = this;
	...
	Drawer$1.prototype.show = function() {
		var _this = this;
		if (this._options.edge) {
			this._getPlacementClasses(this._options.placement + "-edge").active.map(function(c) {
				_this._targetEl.classList.add(c);
	...
	Drawer$1.prototype.toggle = function() {
		if (this.isVisible()) this.hide();
		else this.show();
	};
	Drawer$1.prototype._createBackdrop = function() {
		var _a;
		var _this = this;
		if (!this._visible) {
			var backdropEl = document.createElement("div");
	...
	Drawer$1.prototype.isHidden = function() {
		return !this._visible;
	};
	Drawer$1.prototype.isVisible = function() {
		return this._visible;
	};
	Drawer$1.prototype.addEventListenerInstance = function(element, type, handler) {
		this._eventListenerInstances.push({
			element,
			type,
			handler
	...
	Drawer$1.prototype.removeAllEventListenerInstances = function() {
		this._eventListenerInstances.map(function(eventListenerInstance) {
			eventListenerInstance.element.removeEventListener(eventListenerInstance.type, eventListenerInstance.handler);
		});
		this._eventListenerInstances = [];
	};
	Drawer$1.prototype.getAllEventListenerInstances = function() {
		return this._eventListenerInstances;
	};
	Drawer$1.prototype.updateOnShow = function(callback) {
		this._options.onShow = callback;
	};
	Drawer$1.prototype.updateOnHide = function(callback) {
		this._options.onHide = callback;
	};
	Drawer$1.prototype.updateOnToggle = function(callback) {
		this._options.onToggle = callback;
	};
	return Drawer$1;
}();
...
var Tabs = function() {
	function Tabs$1(tabsEl, items, options, instanceOptions) {
	...
	Tabs$1.prototype.destroy = function() {
		if (this._initialized) this._initialized = false;
	};
	Tabs$1.prototype.removeInstance = function() {
		this.destroy();
		instances_default.removeInstance("Tabs", this._instanceId);
	};
	Tabs$1.prototype.destroyAndRemoveInstance = function() {
		this.destroy();
		this.removeInstance();
	};
	Tabs$1.prototype.getActiveTab = function() {
		return this._activeTab;
	};
	Tabs$1.prototype.setActiveTab = function(tab) {
		this._activeTab = tab;
	};
	Tabs$1.prototype.getTab = function(id) {
		return this._items.filter(function(t) {
			return t.id === id;
		})[0];
	};
	Tabs$1.prototype.show = function(id, forceShow) {
		var _a, _b;
		var _this = this;
		...
		this._items.map(function(t) {
			var _a$1, _b$1;
			if (t !== tab) {
				(_a$1 = t.triggerEl.classList).remove.apply(_a$1, _this._options.activeClasses.split(" "));
				(_b$1 = t.triggerEl.classList).add.apply(_b$1, _this._options.inactiveClasses.split(" "));
	...
	Tabs$1.prototype.updateOnShow = function(callback) {
		this._options.onShow = callback;
	};
	return Tabs$1;
}();
...
var Tooltip = function() {
	function Tooltip$1(targetEl, triggerEl, options, instanceOptions) {
		if (targetEl === void 0) targetEl = null;
		if (triggerEl === void 0) triggerEl = null;
	...
	Tooltip$1.prototype.init = function() {
		if (this._triggerEl && this._targetEl && !this._initialized) {
			this._setupEventListeners();
			this._popperInstance = this._createPopperInstance();
			this._initialized = true;
	...
	Tooltip$1.prototype.removeInstance = function() {
		instances_default.removeInstance("Tooltip", this._instanceId);
	};
	Tooltip$1.prototype.destroyAndRemoveInstance = function() {
		this.destroy();
		this.removeInstance();
	};
	Tooltip$1.prototype._setupEventListeners = function() {
		var _this = this;
		var triggerEvents = this._getTriggerEvents();
	...
	Tooltip$1.prototype._createPopperInstance = function() {
		return createPopper(this._triggerEl, this._targetEl, {
			placement: this._options.placement,
			modifiers: [{
				name: "offset",
	...
	Tooltip$1.prototype._getTriggerEvents = function() {
		switch (this._options.triggerType) {
			case "hover": return {
	...
	Tooltip$1.prototype._setupKeydownListener = function() {
		var _this = this;
		this._keydownEventListener = function(ev) {
			if (ev.key === "Escape") _this.hide();
		};
	...
	Tooltip$1.prototype._removeKeydownListener = function() {
		document.body.removeEventListener("keydown", this._keydownEventListener, true);
	};
	Tooltip$1.prototype._setupClickOutsideListener = function() {
		var _this = this;
		this._clickOutsideEventListener = function(ev) {
			_this._handleClickOutside(ev, _this._targetEl);
		};
	...
	Tooltip$1.prototype._removeClickOutsideListener = function() {
		document.body.removeEventListener("click", this._clickOutsideEventListener, true);
	};
	Tooltip$1.prototype._handleClickOutside = function(ev, targetEl) {
		var clickedEl = ev.target;
		if (clickedEl !== targetEl && !targetEl.contains(clickedEl) && !this._triggerEl.contains(clickedEl) && this.isVisible()) this.hide();
	};
	Tooltip$1.prototype.isVisible = function() {
		return this._visible;
	};
	Tooltip$1.prototype.toggle = function() {
		if (this.isVisible()) this.hide();
		else this.show();
	};
	Tooltip$1.prototype.show = function() {
	...
	Tooltip$1.prototype.hide = function() {
	...
	Tooltip$1.prototype.updateOnShow = function(callback) {
		this._options.onShow = callback;
	};
	Tooltip$1.prototype.updateOnHide = function(callback) {
		this._options.onHide = callback;
	};
	Tooltip$1.prototype.updateOnToggle = function(callback) {
		this._options.onToggle = callback;
	};
	return Tooltip$1;
}();
...
var Popover = function() {
	function Popover$1(targetEl, triggerEl, options, instanceOptions) {
		if (targetEl === void 0) targetEl = null;
		if (triggerEl === void 0) triggerEl = null;
	...
	Popover$1.prototype.init = function() {
		if (this._triggerEl && this._targetEl && !this._initialized) {
			this._setupEventListeners();
			this._popperInstance = this._createPopperInstance();
			this._initialized = true;
	...
	Popover$1.prototype.destroy = function() {
		var _this = this;
		if (this._initialized) {
			var triggerEvents = this._getTriggerEvents();
			triggerEvents.showEvents.forEach(function(ev) {
	...
	Popover$1.prototype.removeInstance = function() {
		instances_default.removeInstance("Popover", this._instanceId);
	};
	Popover$1.prototype.destroyAndRemoveInstance = function() {
		this.destroy();
		this.removeInstance();
	};
	Popover$1.prototype._setupEventListeners = function() {
		var _this = this;
		var triggerEvents = this._getTriggerEvents();
		this._showHandler = function() {
			_this.show();
	...
	Popover$1.prototype._createPopperInstance = function() {
		return createPopper(this._triggerEl, this._targetEl, {
			placement: this._options.placement,
			modifiers: [{
				name: "offset",
	...
	Popover$1.prototype._getTriggerEvents = function() {
		switch (this._options.triggerType) {
			case "hover": return {
				showEvents: ["mouseenter", "focus"],
				hideEvents: ["mouseleave", "blur"]
	...
	Popover$1.prototype._setupKeydownListener = function() {
		var _this = this;
		this._keydownEventListener = function(ev) {
			if (ev.key === "Escape") _this.hide();
		};
	...
	Popover$1.prototype._removeKeydownListener = function() {
		document.body.removeEventListener("keydown", this._keydownEventListener, true);
	};
	Popover$1.prototype._setupClickOutsideListener = function() {
		var _this = this;
		this._clickOutsideEventListener = function(ev) {
			_this._handleClickOutside(ev, _this._targetEl);
		};
	...
	Popover$1.prototype._removeClickOutsideListener = function() {
		document.body.removeEventListener("click", this._clickOutsideEventListener, true);
	};
	Popover$1.prototype._handleClickOutside = function(ev, targetEl) {
		var clickedEl = ev.target;
		if (clickedEl !== targetEl && !targetEl.contains(clickedEl) && !this._triggerEl.contains(clickedEl) && this.isVisible()) this.hide();
	};
	Popover$1.prototype.isVisible = function() {
		return this._visible;
	};
	Popover$1.prototype.toggle = function() {
		if (this.isVisible()) this.hide();
		else this.show();
		this._options.onToggle(this);
	};
	Popover$1.prototype.show = function() {
		this._targetEl.classList.remove("opacity-0", "invisible");
		this._targetEl.classList.add("opacity-100", "visible");
		this._popperInstance.setOptions(function(options) {
	...
	Popover$1.prototype.hide = function() {
		this._targetEl.classList.remove("opacity-100", "visible");
		this._targetEl.classList.add("opacity-0", "invisible");
		this._popperInstance.setOptions(function(options) {
			return __assign$4(__assign$4({}, options), { modifiers: __spreadArray(__spreadArray([], options.modifiers, true), [{
	...
	Popover$1.prototype.updateOnShow = function(callback) {
		this._options.onShow = callback;
	};
	Popover$1.prototype.updateOnHide = function(callback) {
		this._options.onHide = callback;
	};
	Popover$1.prototype.updateOnToggle = function(callback) {
		this._options.onToggle = callback;
	};
	return Popover$1;
}();
function initPopovers() {
	document.querySelectorAll("[data-popover-target]").forEach(function($triggerEl) {
		...
		if ($popoverEl) {
			...
			var offset$1 = $triggerEl.getAttribute("data-popover-offset");
			new Popover($popoverEl, $triggerEl, {
				placement: placement ? placement : Default$4.placement,
				offset: offset$1 ? parseInt(offset$1) : Default$4.offset,
...
var Dial = function() {
	function Dial$1(parentEl, triggerEl, targetEl, options, instanceOptions) {
	...
	Dial$1.prototype.init = function() {
		var _this = this;
		if (this._triggerEl && this._targetEl && !this._initialized) {
	...
	Dial$1.prototype.destroy = function() {
		var _this = this;
		if (this._initialized) {
			var triggerEventTypes = this._getTriggerEventTypes(this._options.triggerType);
			triggerEventTypes.showEvents.forEach(function(ev) {
	...
	Dial$1.prototype.removeInstance = function() {
		instances_default.removeInstance("Dial", this._instanceId);
	};
	Dial$1.prototype.destroyAndRemoveInstance = function() {
		this.destroy();
		this.removeInstance();
	};
	Dial$1.prototype.hide = function() {
		this._targetEl.classList.add("hidden");
		if (this._triggerEl) this._triggerEl.setAttribute("aria-expanded", "false");
		this._visible = false;
		this._options.onHide(this);
	};
	Dial$1.prototype.show = function() {
		this._targetEl.classList.remove("hidden");
		if (this._triggerEl) this._triggerEl.setAttribute("aria-expanded", "true");
		this._visible = true;
		this._options.onShow(this);
	};
	Dial$1.prototype.toggle = function() {
		if (this._visible) this.hide();
		else this.show();
	};
	Dial$1.prototype.isHidden = function() {
		return !this._visible;
	};
	Dial$1.prototype.isVisible = function() {
		return this._visible;
	};
	Dial$1.prototype._getTriggerEventTypes = function(triggerType) {
		switch (triggerType) {
			case "hover": return {
				showEvents: ["mouseenter", "focus"],
				hideEvents: ["mouseleave", "blur"]
	...
	Dial$1.prototype.updateOnShow = function(callback) {
		this._options.onShow = callback;
	};
	Dial$1.prototype.updateOnHide = function(callback) {
		this._options.onHide = callback;
	};
	Dial$1.prototype.updateOnToggle = function(callback) {
		this._options.onToggle = callback;
	};
	return Dial$1;
}();
...
var InputCounter = function() {
	function InputCounter$1(targetEl, incrementEl, decrementEl, options, instanceOptions) {
		if (targetEl === void 0) targetEl = null;
	...
	InputCounter$1.prototype.init = function() {
		var _this = this;
		if (this._targetEl && !this._initialized) {
	...
	InputCounter$1.prototype.destroy = function() {
		if (this._targetEl && this._initialized) {
	...
	InputCounter$1.prototype.removeInstance = function() {
		instances_default.removeInstance("InputCounter", this._instanceId);
	};
	InputCounter$1.prototype.destroyAndRemoveInstance = function() {
		this.destroy();
		this.removeInstance();
	};
	InputCounter$1.prototype.getCurrentValue = function() {
		return parseInt(this._targetEl.value) || 0;
	};
	InputCounter$1.prototype.increment = function() {
		if (this._options.maxValue !== null && this.getCurrentValue() >= this._options.maxValue) return;
		this._targetEl.value = (this.getCurrentValue() + 1).toString();
		this._options.onIncrement(this);
	};
	InputCounter$1.prototype.decrement = function() {
		if (this._options.minValue !== null && this.getCurrentValue() <= this._options.minValue) return;
		this._targetEl.value = (this.getCurrentValue() - 1).toString();
		this._options.onDecrement(this);
	};
	InputCounter$1.prototype.updateOnIncrement = function(callback) {
		this._options.onIncrement = callback;
	};
	InputCounter$1.prototype.updateOnDecrement = function(callback) {
...
function initInputCounters() {
	document.querySelectorAll("[data-input-counter]").forEach(function($targetEl) {
		...
		if ($targetEl) {
			if (!instances_default.instanceExists("InputCounter", $targetEl.getAttribute("id"))) new InputCounter($targetEl, $incrementEl ? $incrementEl : null, $decrementEl ? $decrementEl : null, {
...
var CopyClipboard = function() {
	function CopyClipboard$1(triggerEl, targetEl, options, instanceOptions) {
		if (triggerEl === void 0) triggerEl = null;
		if (targetEl === void 0) targetEl = null;
	...
	CopyClipboard$1.prototype.init = function() {
		var _this = this;
	...
	CopyClipboard$1.prototype.destroy = function() {
		if (this._triggerEl && this._targetEl && this._initialized) {
			if (this._triggerEl) this._triggerEl.removeEventListener("click", this._triggerElClickHandler);
			this._initialized = false;
		}
	};
	CopyClipboard$1.prototype.removeInstance = function() {
		instances_default.removeInstance("CopyClipboard", this._instanceId);
	};
	CopyClipboard$1.prototype.destroyAndRemoveInstance = function() {
		this.destroy();
		this.removeInstance();
	};
	CopyClipboard$1.prototype.getTargetValue = function() {
	...
	CopyClipboard$1.prototype.copy = function() {
	...
	CopyClipboard$1.prototype.decodeHTML = function(html) {
		var textarea = document.createElement("textarea");
		textarea.innerHTML = html;
		return textarea.textContent;
	};
	CopyClipboard$1.prototype.updateOnCopyCallback = function(callback) {
		this._options.onCopy = callback;
	};
	return CopyClipboard$1;
}();
function initCopyClipboards() {
	document.querySelectorAll("[data-copy-to-clipboard-target]").forEach(function($triggerEl) {
		...
		if ($targetEl) {
			if (!instances_default.instanceExists("CopyClipboard", $targetEl.getAttribute("id"))) new CopyClipboard($triggerEl, $targetEl, {
...
function isInRange(testVal, min$1, max$1) {
	return (min$1 === void 0 || testVal >= min$1) && (max$1 === void 0 || testVal <= max$1);
}
function limitToRange(val, min$1, max$1) {
	if (val < min$1) return min$1;
...
var parseFns = {
	...
	m: function m(date, month, locale) {
		...
		if (isNaN(monthIndex)) {
			...
			var compareNames = function compareNames$1(name) {
...
if (!Event.prototype.composedPath) {
	var getComposedPath = function getComposedPath$1(node) {
		...
		return parent ? getComposedPath$1(parent, path) : path;
	};
...
function validateViewId(value, origValue) {
	var max$1 = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 3;
	var viewId = parseInt(value, 10);
	return viewId >= 0 && viewId <= max$1 ? viewId : origValue;
}
function processOptions(options, datepicker) {
	var inOpts = Object.assign({}, options);
	var config = {};
	var locales$1 = datepicker.constructor.locales;
	...
	if (inOpts.language) {
		var lang;
		if (inOpts.language !== language) if (locales$1[inOpts.language]) lang = inOpts.language;
		else {
			lang = inOpts.language.split("-")[0];
			if (locales$1[lang] === void 0) lang = false;
		}
		delete inOpts.language;
		if (lang) {
			language = config.language = lang;
			var origLocale = locale || locales$1[defaultLang];
			locale = Object.assign({
				format: defaultFormat,
				weekStart: defaultWeekStart
			}, locales$1[defaultLang]);
			if (language !== defaultLang) Object.assign(locale, locales$1[language]);
...
var DaysView = /* @__PURE__ */ function(_View) {
	function DaysView$1(picker) {
		_classCallCheck(this, DaysView$1);
		return _callSuper(this, DaysView$1, [picker, {
			id: 0,
			name: "days",
			cellClass: "day"
		}]);
	}
	_inherits(DaysView$1, _View);
	return _createClass(DaysView$1, [
		{
			key: "init",
			value: function init(options) {
				...
				_get(_getPrototypeOf(DaysView$1.prototype), "init", this).call(this, options);
			}
		},
		{
			key: "setOptions",
		...
		},
		{
			...
			value: function updateFocus() {
				...
				var start$1 = dayOfTheWeekOf(firstOfMonth, this.weekStart, this.weekStart);
...
function computeMonthRange(range$1, thisYear) {
	if (!range$1 || !range$1[0] || !range$1[1]) return;
	var _range = _slicedToArray(range$1, 2), _range$ = _slicedToArray(_range[0], 2), startY = _range$[0], startM = _range$[1], _range$2 = _slicedToArray(_range[1], 2), endY = _range$2[0], endM = _range$2[1];
	if (startY > thisYear || endY < thisYear) return;
	return [startY === thisYear ? startM : -1, endY === thisYear ? endM : 12];
}
var MonthsView = /* @__PURE__ */ function(_View) {
	function MonthsView$1(picker) {
		_classCallCheck(this, MonthsView$1);
		return _callSuper(this, MonthsView$1, [picker, {
			id: 1,
			name: "months",
			cellClass: "month"
		}]);
	}
	_inherits(MonthsView$1, _View);
	return _createClass(MonthsView$1, [
		{
			key: "init",
			value: function init(options) {
				if (arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true) {
				...
				_get(_getPrototypeOf(MonthsView$1.prototype), "init", this).call(this, options);
			}
		},
		{
			key: "setOptions",
		...
		},
		{
			...
			value: function render() {
				...
				var range$1 = computeMonthRange(this.range, this.year);
				Array.from(this.grid.children).forEach(function(el, index) {
					var classList = el.classList;
					...
					if (range$1) {
						var _range2 = _slicedToArray(range$1, 2), rangeStart = _range2[0], rangeEnd = _range2[1];
...
var YearsView = /* @__PURE__ */ function(_View) {
	function YearsView$1(picker, config) {
		_classCallCheck(this, YearsView$1);
		return _callSuper(this, YearsView$1, [picker, config]);
	}
	_inherits(YearsView$1, _View);
	return _createClass(YearsView$1, [
		{
			key: "init",
			value: function init(options) {
				if (arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true) {
				...
				_get(_getPrototypeOf(YearsView$1.prototype), "init", this).call(this, options);
			}
		},
		{
			key: "setOptions",
...
var Picker = /* @__PURE__ */ function() {
	function Picker$1(datepicker) {
		...
		var _element$firstChild$c = _slicedToArray(element.firstChild.children, 3), header = _element$firstChild$c[0], main$1 = _element$firstChild$c[1], footer = _element$firstChild$c[2];
		...
		},
		{
			...
			value: function place() {
				...
				if (container === document.body) {
					...
					left$1 = inputLeft + window.scrollX;
					top$1 = inputTop + scrollTop;
				} else {
					scrollTop = container.scrollTop;
					left$1 = inputLeft - containerLeft;
					top$1 = inputTop - containerTop + scrollTop;
				}
				if (orientX === "auto") if (left$1 < 0) {
					orientX = "left";
					left$1 = 10;
				} else if (left$1 + calendarWidth > containerWidth) orientX = "right";
				else orientX = getTextDirection(inputField) === "rtl" ? "right" : "left";
				if (orientX === "right") left$1 -= calendarWidth - inputWidth;
				if (orientY === "auto") orientY = top$1 - calendarHeight < scrollTop ? "bottom" : "top";
				if (orientY === "top") top$1 -= calendarHeight;
				else top$1 += inputHeight;
				classList.remove("datepicker-orient-top", "datepicker-orient-bottom", "datepicker-orient-right", "datepicker-orient-left");
				classList.add("datepicker-orient-".concat(orientY), "datepicker-orient-".concat(orientX));
				style.top = top$1 ? "".concat(top$1, "px") : top$1;
				style.left = left$1 ? "".concat(left$1, "px") : left$1;
			}
		},
		{
...
function findNextAvailableOne(date, addFn, increase, testFn, min$1, max$1) {
	if (!isInRange(date, min$1, max$1)) return;
	if (testFn(date)) return findNextAvailableOne(addFn(date, increase), addFn, increase, testFn, min$1, max$1);
	return date;
}
...
var Datepicker = /* @__PURE__ */ function() {
	...
	*/
	return _createClass(Datepicker$2, [
		{
			key: "active",
			get: function get() {
...
var DateRangePicker = /* @__PURE__ */ function() {
	...
	* @param  {Object} [options] - config options
	*/
	function DateRangePicker$1(element) {
		var options = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
		_classCallCheck(this, DateRangePicker$1);
	...
	*/
	return _createClass(DateRangePicker$1, [
		{
			key: "dates",
			get: function get() {
...
var Datepicker$1 = function() {
	function Datepicker$2(datepickerEl, options, instanceOptions) {
	...
	Datepicker$2.prototype.init = function() {
		if (this._datepickerEl && !this._initialized) {
			...
			else this._datepickerInstance = new Datepicker(this._datepickerEl, this._getDatepickerOptions(this._options));
			this._initialized = true;
		}
	};
	Datepicker$2.prototype.destroy = function() {
		if (this._initialized) {
			this._initialized = false;
			this._datepickerInstance.destroy();
		}
	};
	Datepicker$2.prototype.removeInstance = function() {
		this.destroy();
		instances_default.removeInstance("Datepicker", this._instanceId);
	};
	Datepicker$2.prototype.destroyAndRemoveInstance = function() {
		this.destroy();
		this.removeInstance();
	};
	Datepicker$2.prototype.getDatepickerInstance = function() {
		return this._datepickerInstance;
	};
	Datepicker$2.prototype.getDate = function() {
		...
		if (!this._options.rangePicker && this._datepickerInstance instanceof Datepicker) return this._datepickerInstance.getDate();
	};
	Datepicker$2.prototype.setDate = function(date) {
		...
		if (!this._options.rangePicker && this._datepickerInstance instanceof Datepicker) return this._datepickerInstance.setDate(date);
	};
	Datepicker$2.prototype.show = function() {
		this._datepickerInstance.show();
		this._options.onShow(this);
	};
	Datepicker$2.prototype.hide = function() {
		this._datepickerInstance.hide();
		this._options.onHide(this);
	};
	Datepicker$2.prototype._getDatepickerOptions = function(options) {
	...
	Datepicker$2.prototype.updateOnShow = function(callback) {
		this._options.onShow = callback;
	};
	Datepicker$2.prototype.updateOnHide = function(callback) {
		this._options.onHide = callback;
	};
	return Datepicker$2;
}();
...
if (typeof window !== "undefined") {
	window.Datepicker = Datepicker$1;
